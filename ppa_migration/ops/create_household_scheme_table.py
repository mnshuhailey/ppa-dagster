...
@op(ins={"after_create_snapshot": In(Nothing)}, required_resource_keys={"sqlserver_db"})
def create_household_scheme_table(context):
    base_dir = os.path.dirname(os.path.realpath(__file__))
    sql_file_path = os.path.join(base_dir, '../sql/create_household_scheme_table.sql')
