...
@op(ins={"after_create_hadkifayah": In(Nothing)}, required_resource_keys={"postgres_db"}, out=Out(list))
def transform_asnaf_data(context):
    base_dir = os.path.dirname(os.path.realpath(__file__))
    fetch_data_query_path = os.path.join(base_dir, '../sql/transform_asnaf_data.sql')
